...
(function ($, window) {
  ...
  $.fn.stickyNavbar = function (prop) {
    ...
    var stickyPosition = header ? header.outerHeight(true) + adminBar : 0
    ...
    function addActiveState(sections) {
      ...
      sections.each(function (index) {
          var top = $(this).offset().top  - 90
            , bottom = $(this).outerHeight(true) + top + 90;
      ...
      if (location.pathname.replace(/^\//, '') == this.pathname.replace(/^\//, '') && location.hostname == this.hostname) {
        ...
        if (target.length) {
          $('html, body').stop().animate({
            scrollTop: target.offset().top - stickyPosition - navBarHeight - 90
          }, {
